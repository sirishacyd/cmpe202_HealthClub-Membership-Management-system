...
class signUpTraining(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
            ...
            if catch_training.current_capacity > catch_training.max_capacity:
                return Response({'error': 'Capacity for the training session is full, please reachout health club employee for further information'}, status=status.HTTP_400_BAD_REQUEST)
            catch_training.save()
